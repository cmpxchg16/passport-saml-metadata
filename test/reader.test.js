...
describe('MetadataReader', () => {
  ...
  describe('parses correctly multiline certificate key as multiline', () => {
    let config;
    const expectedCertificate =
``;

    before(() => {
      config = new MetadataReader(metadataCertKeyMultiline);
    });

    it('encryptionCertMultiline', () => {
      assert.strictEqual(config.encryptionCert(false), expectedCertificate);
    });

    it('signingCertMultiline', () => {
      assert.strictEqual(config.signingCert(false), expectedCertificate);
    });
  });
